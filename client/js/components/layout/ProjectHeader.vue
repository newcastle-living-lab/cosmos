	...
	<section class="project-header">
		...
		<nav class="navbar">
			...
			<section class="navbar-section navbar-buttons">
				...
				<span class="btn btn-sm btn-empty" v-if="!hasProject"> </span>

				<span class='navbar-brand' v-if="hasProject">{{ project.name }}</span>
...
export default {
	...
	computed: {
		...
		hasProject() {
			return (this.route && this.route.params.id && this.project && this.project.id ? true : false);
		},
